...
use MediaWiki\Extension\CodeReview\UI\CodeRevisionListView;
use stdClass;
...
class ApiQueryCodeRevisions extends ApiQueryBase {
	...
	public function execute() {
		...
		ApiResult::setIndexedTagName( $data, 'revision' );
	...
	public function getAllowedParams() {
		return [
			...
			'prop' => [
				ParamValidator::PARAM_ISMULTI => true,
				ParamValidator::PARAM_DEFAULT => 'revid|status|author|timestamp',
